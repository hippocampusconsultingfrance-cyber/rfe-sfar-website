...
var DOC_META = {
  ...
  gestion_traitements_chroniques_infectieux_2009: {
    key: 'gestion_traitements_chroniques_infectieux_2009',
    badge: "SFAR RFE 2009 — Module 3/4 (périmètre limité)",
    title: "Gestion périopératoire des traitements chroniques — Anti-infectieux, immunosuppresseurs",
    short: "SFAR, « Gestion périopératoire des traitements chroniques et dispositifs médicaux — Anti-infectieux, immunosuppresseurs », RFE, Ann Fr Anesth Réanim 28 (2009) 1057-1065. Même document source composite que les Modules 1, 2 et 4 (fiches séparées — la fiche bibliothèque de ce document source unique renvoie vers le Module 1 ; accédez à ce Module 3 directement via cette carte ou la barre latérale). Ce module ACHÈVE la couverture des 4 modules effectivement présents dans le PDF fusionné de ce référentiel. Couvre : antituberculeux, antirétroviraux, et 6 immunosuppresseurs distincts — inhibiteurs de calcineurine (ciclosporine, tacrolimus), thalidomide, méthotrexate, azathioprine, mycophénolate mofétil, cyclophosphamide, anticorps monoclonaux anti-TNF. Seuls deux grades apparaissent effectivement dans ce module (grille ANAES 2004) : grade C (faible niveau de preuve) et accord fort (grade D renforcé par méthode Delphi, même convention que les Modules 1/2) — aucune citation A, B ou D nu. 30 lignes de recommandations gradées (accord fort:16, grade C:14) ; le module anti-TNF consolide 3 citations de même grade portant sur le même scénario clinique (dont une phrase source dupliquée mot pour mot dans le texte) en une seule ligne, sans jamais fusionner des grades différents.",
    society: "SFAR (Société française d'anesthésie et de réanimation)",
    version: "2009",
    validated: "Comité des référentiels de la SFAR",
